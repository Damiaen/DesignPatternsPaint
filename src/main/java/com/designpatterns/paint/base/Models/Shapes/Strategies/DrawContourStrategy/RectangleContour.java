...
public class RectangleContour implements ShapeContourStrategy {
    ...
    public void drawContour(Graphics g, BaseShape baseShape, Color color) {
        ...
        g2d.fillRect((int) (baseShape.getPosition().x - (baseShape.getWidth() / 2.0D) - 3), (int) ((baseShape.getPosition().y - (baseShape.getHeight() / 2.0D)) - 3), baseShape.getWidth() + 6, baseShape.getHeight() + 6);
    }
}
