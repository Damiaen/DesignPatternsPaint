...
public class EllipseContour implements ShapeContourStrategy {
    ...
    public void drawContour(Graphics g, BaseShape baseShape, Color color) {
        ...
        g2d.fillOval((int) (baseShape.getPosition().x - (baseShape.getWidth() / 2.0D) - 3), (int) (baseShape.getPosition().y - (baseShape.getHeight() / 2.0D) - 3), (int) baseShape.getWidth() + 6, (int) baseShape.getHeight() + 6);
    }
}
