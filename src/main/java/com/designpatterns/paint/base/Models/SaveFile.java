...
public class SaveFile {
    ...
    private ShapeVisitorSave saveVisitor = new ShapeVisitorSave();
    ...
    public void save(List<Shape> shapes) {
        ...
        for (Object s : shapes) {
            ...
            if (s instanceof Shape) {
                newShapeDetailsObject = createEllipseObject((Shape) s);
            }
    ...
    private JSONObject createEllipseObject(Shape ellipse) {
        String string = ellipse.accept(saveVisitor);
